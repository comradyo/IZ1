...
int main(int argc, char* argv[]) {
    ...
    generate_file_with_vector("test_vector_5.txt", 5);
    generate_file_with_array("test_array_5000_5.txt", 5000, 5);

    generate_file_with_vector("test_vector_20.txt", 20);
    generate_file_with_array("test_array_10000_20.txt", 10000, 20);

    generate_file_with_vector("test_vector_100.txt", 100);
    generate_file_with_array("test_array_50000_100.txt", 50000, 100);
